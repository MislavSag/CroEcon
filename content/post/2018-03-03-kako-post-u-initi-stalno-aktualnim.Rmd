---
title: CroEcon - differentia specifica
author: Mislav Sagovac
date: '2018-03-03'
slug: croecon-differentia-specifica
categories:
  - R
tags:
  - R
...
Iako programskom jeziku R [popularnost snažno raste](https://www.tiobe.com/tiobe-index/), još je uvijek je relativno nepoznat među ljudima koji po struci nisu informatičari ili nisu vezani uz područje *data science-a*. Valja napomenuti da se radi *open-source* ("besplatnom") programskom jeziku, primarno orijentiranom na razvoj statističkih modela i grafičku analizu. Međutim, R pruža mnogo više od toga, pa tako omogućuje i pisanje blogova na posebnoj web stranici poput ove, korištenje tehnika *web scraping*-a, izradu spomenutih web aplikacija i td. Ipak, glavni naglasak je na razvoju statističkih paketa (posebno za strojno učenje). R se može preuzeti sa sljedeće web [stranice](https://www.tiobe.com/tiobe-index/). Uz R se gotovo uvijek instalira i besplatno okruženje za R, [R studio](https://www.rstudio.com/). Ovo sve napominjemo kako bi čitatelji mogli samostalno replicirati neke kodove koje ćemo koristiti u R-u.
